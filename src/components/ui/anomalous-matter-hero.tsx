...
export function AnomalousMatterHero({
  ...
  return <section role="banner" className="relative w-full h-screen bg-background text-foreground overflow-hidden">
      ...
      <a
        ...
        className="absolute top-6 md:top-8 right-4 md:right-8 z-30 text-xs md:text-sm font-mono tracking-widest uppercase text-foreground hover:opacity-70 transition-opacity cursor-pointer"
      >
        LP Login
      </a>
      <TimeDisplay />
